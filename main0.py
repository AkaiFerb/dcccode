...
parser.add_argument('--dataset', default='yoochoose1_64', help='diginetica/Nowplaying/Tmall/yoochoose1_4/yoochoose1_64')
...
parser.add_argument('--dropout_gcn', type=float, default=0.2, help='Dropout rate.')       # [0, 0.2, 0.4, 0.6, 0.8]
parser.add_argument('--dropout_local', type=float, default=0.0, help='Dropout rate.')     # [0, 0.5]
